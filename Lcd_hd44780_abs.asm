; vim:set syntax=pic ts=4 sts=4 sw=4: 堀野守克 Last Change:2010/07/03 16:14:49.
;	Lcd_hd44780_abs.asm		これはabsolute用である
...
;	#include	<d:\1_PIC\MyLibrary\Pamscls_rel.inc>	;relocatable
