; vim:set syntax=pic ts=4 sts=4 sw=4: 堀野守克 Last Change:2012/03/18 14:35:47.
;	Lcd_rel.asm		これはrelocatable用である
;	http://picbegin.hp.infoseek.co.jp/proj5/p5step80.html
;	hardの設定はヘッダーファイル[Lcd_header.inc]を変更すことにより可能である
...
;+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#include	<d:\1_PIC\MyLibrary\Pamscls_rel.inc>	;
;		main以外のアセンブル単位でPamsclsを使う場合あるいはeepromのI/Oを行う
;		場合にはPamscls_variable.incの代わりにPamscls_rel_extern_variable.inc
;		をincludeする
;+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	#include	<d:\1_PIC\MyLibrary\Lcd_header.inc>
						;Lcd_header.incはabs, rel共通
;***** 変数定義 **************************************
lcd_grp	udata		;relocatableだから
_?lcd_cmode		res	1
_?lcd_dmode		res	1
_?lcd_emode		res	1
_?lcd_fmode		res	1
...
;******************************************************
	global	_?lcd_x,_?lcd_y,_?lcd_dmode,_?lcd_temp
	global	Lcd_init,Lcd_dmode,Lcd_clear,Lcd_ddram,Lcd_loc,Lcd_out,Lcd_dat
	extern	_?sCount
	extern	Delay_10ms,Delay_100us
;******************************************************
lcd_code	code	h'd00'	;プログラムはここから始まる
;lcd_code	code	h'e40'	;プログラムはここから始まる
;lcd_code	code	h'ea7'	;プログラムはここから始まる
				;relocatableだから
;******************************************************
;		Lcd Control Library
